...
- Tasteful (but opinionated) UI, following modern SwiftUI UI/UX guidelines
  - Fifteen themes, including clean light/dark modes, GitHub and Catppuccin variations, Everforest Light, Gruvbox Dark, Nord, Rose Pine, Solarized Sepia, Cyberpunk, Greyscale, and a C64-inspired palette :-)
